...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="bg-gray-900 shadow-lg rounded-lg p-6">
      ...
      <p className="text-sm text-gray-400 mb-6">Last updated: January 21, 2025</p>
      ...
      <div className="mb-6">
        ...
        {/* <!-- Interpretation --> */}
        <div className="mb-4">
          <h3 className="text-xl font-medium text-white mb-2">Interpretation</h3>
          <p className="text-gray-300">
            ...
            regardless of whether the words appear in singular or plural forms.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-3">
            ...
            <li>
              <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NiN Supply.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Third-party Social Media Service</strong> refers to any website or social network website through which a User can log in or create an account to use the Service.</p>
            </li>
            <li>
              <p><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
            </li>
            <li>
              <p><strong>Website</strong> refers to NiN Supply, accessible from{" "}
                <a href="https://nin-supply.vercel.app/" 
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to NiN Supply.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        Company through Your Third-Party Social Media Service&lsquo;s account.
