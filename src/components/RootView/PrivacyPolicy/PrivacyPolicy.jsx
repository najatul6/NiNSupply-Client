    ...
    <Container>
        <div className="bg-gray-900 shadow-lg rounded-lg px-2 md:px-4 py-4 text-justify">
          ...
          <div className="mb-6">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-300">
                Words with their initial letter capitalized have specific
                meanings defined under the following conditions. The definitions
                apply regardless of whether the words appear in singular or
                plural forms.
              </p>
            </div>
          ...
          <p className="text-gray-300 mb-3">
            ...
            Service&lsquo;s account, such as Your name, Your email address, Your
