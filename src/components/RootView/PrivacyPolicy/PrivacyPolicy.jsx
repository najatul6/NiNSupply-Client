  ...
  return (
    <Container>
      <div className="bg-gray-900 shadow-lg rounded-lg px-2 md:px-4 py-4 text-justify">
        ...
        <div className="mb-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-300">
              ...
              defined under the following conditions. The definitions apply
              regardless of whether the words appear in singular or plural
              forms.
            </p>
          </div>
          ...
          {/* <!-- Definitions --> */}
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Definitions</h3>
            <p className="text-gray-300">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-3">
              ...
              <li>
                ...
                website or social network website through which a User can log
        ...
        <h4 className="text-lg font-medium text-white mb-2">Law enforcement</h4>
        <p className="text-gray-300 mb-3">
